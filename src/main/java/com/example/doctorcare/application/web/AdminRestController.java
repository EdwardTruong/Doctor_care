...
// import com.example.doctorcare.application.service.management.AdminService;
...
//  * 	-USER - (PATIENT).
//  * 
//  *  1.The activeAccount method is used to update the active field value of the User. (1->0 or 0->1).
//  *  2 The addDoctor method using create a new DoctorEntity (create User with role DOCTOR and add more infomations for DoctorEntity)
//  * 
//  */
...
// 		// User User = adminService.createrUserForDoctorAccount(signUpRequest, role);
// 		// DoctorDtoResponse newDoc = doctorService.createNewDoctor(signUpRequest, User, specializations, clinic);
