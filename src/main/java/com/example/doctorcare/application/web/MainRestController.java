...
import com.example.doctorcare.infrastructure.common.utils.Const.JWT_HEARD;
 ...
 * 	The User's field LocalDateTime createdAt can't save exactly the time 
...
public class MainRestController {
	...
	// 	User newUser = userService.createUser(signUpRequest, role);
	...
	// 	Session getNewSession = sessionService.sendEmailCreateKeyURl(User);
	...
	// 	User User = loginService.changingPassword(request, session);
	// 	logger.info(appUtils.convertLocalDateTimeToString(User.getUpdatedAt()));
