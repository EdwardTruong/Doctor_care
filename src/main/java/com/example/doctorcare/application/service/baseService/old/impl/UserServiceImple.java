...
// import com.example.doctorcare.application.exception.EmailExistException;
// import com.example.doctorcare.application.exception.PasswordRegisterErrors;
...
// import com.example.doctorcare.application.service.UserService;
...
// import com.example.doctorcare.infrastructure.security.custom.UserDetailsCustom;
// import com.example.doctorcare.infrastructure.security.jwt.JwtUtils;
// import com.example.doctorcare.infrastructure.utils.ApplicationUtils;
// import com.example.doctorcare.infrastructure.utils.Const.ACTIVE;
// import com.example.doctorcare.infrastructure.utils.Const.MESSENGER;
// import com.example.doctorcare.infrastructure.utils.Const.MESSENGER_ERROR;
// import com.example.doctorcare.infrastructure.utils.Const.MESSENGER_NOT_FOUND;
// import com.example.doctorcare.infrastructure.utils.Const.PASSWORD;
// import com.example.doctorcare.infrastructure.utils.Const.VIEW;
...
// 		Optional<User> resutl = userDao.findById(id);
...
// 		User userUpdated = this.update(user, request);
// 		return userMapper.toDto(userUpdated, MESSENGER.UPDATE_INFO);
// 	}

// 	@Override
// 	public boolean emailExist(String email) {
// 		Optional<User> resutl = userDao.findUserByEmail(email);
...
// 	@Override
// 	public User createrUserForDoctorAccount(SignupDoctorRequest docRequest, RoleEntity role) {
...
// 	@Override
// 	@Transactional
// 	public User createrUser(SignupRequest signUpRequest, RoleEntity role) {
...
// 	@Override
// 	public UserDtoResponse createUser(SignupRequest signUpRequest, RoleEntity role) {
// 		User user = this.createrUser(signUpRequest, role);
...
// 		return userMapper.toDto(User, result);
// 	}
