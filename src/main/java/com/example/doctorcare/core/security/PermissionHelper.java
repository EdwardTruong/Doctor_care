...
import com.example.doctorcare.domain.permission.Permission;
...
public class PermissionHelper {
     ...
     * @return Chuỗi khóa quyền đã được định dạng (ví dụ: "EDIT:ENTERPRISE:OWN").
     */
     ...
     * @param resource Tài nguyên của quyền.
     * @param scope    Phạm vi của quyền.
     * @return Tên hiển thị thân thiện với người dùng (ví dụ: "Chỉnh sửa Doanh nghiệp (Sở hữu)").
     */
